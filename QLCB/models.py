...
class Flights(db.Model):
    ...
    def __str__(self):
        return 'Id flight ' + str(self.id) + ' (from ' + self.startAirport.airportName + ' to ' + self.destinationAirport.airportName + ')'
...
class BookDetails(db.Model):
    ...
    def __str__(self):
        return 'From ' + self.flight.startAirport.airportName + ' to ' + self.flight.destinationAirport.airportName + ' - Customer: ' + self.customer.customerName + ' (' + self.customer.phone + ')'
