...
class FlightModelView(AuthenticatedModelView):
    ...
    list_columns = ['id', 'startAirport', 'destinationAirport', 'takeOffTime', 'flightTime', 'noBusinessClass', 'noEconomyClass', 'priceBusinessClass', 'priceEconomyClass']
...
class TicketModelView(AuthenticatedModelView):
    ...
    list_columns = ['id', 'price', 'ticketType', 'bookDetail']
    column_labels = dict(id='ID',
                         price='Price',
